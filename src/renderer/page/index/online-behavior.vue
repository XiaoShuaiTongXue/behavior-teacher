      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-6" v-if="state || end">
          <div class="card">
            ...
            <div class="card-body">
              <v-chart style="width: 420px;height: 205px" :options="polar" key="211"/>
            </div>
          </div>
        </div>
        <div class="col-12 col-xl-6" v-if="state || end">
        ...
        <div class="col-12 col-lg-6" v-if="state || end">
          <div class="card">
            ...
            <div class="card-body">
              <v-chart style="width: 420px;height: 320px" :options="option" key="212"/>
            </div>
          </div>
        </div>
        <div class="col-12" v-if="state || end">
          <div class="card">
            ...
            <v-chart :options="timePolar" style="width: 950px;" key="213"></v-chart>
          </div>
        </div>
      </div>
